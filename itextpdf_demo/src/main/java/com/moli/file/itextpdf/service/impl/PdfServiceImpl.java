package com.moli.file.itextpdf.service.impl;
...
import com.moli.file.itextpdf.pdf.MyHeaderFooterPageEventHelper;
...
public class PdfServiceImpl implements PdfService {
    ...
    public Document generateItextPdfDocument(OutputStream os) throws Exception {
        ...
        instance.setPageEvent(new MyHeaderFooterPageEventHelper("Java 全栈知识体系", "SpringBoot集成ItextPDF导出", "https://pdai.tech", "https://pdai.tech"));
        // open
        document.open();
